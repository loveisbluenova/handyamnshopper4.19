...
// ========================= Masonry ===============================
  ...
  $.Mason.prototype = {
    ...
    _create : function( options ) {
	  ...
	  //alert(this.offset.y)
	  /* Additionally Removed extra webkit(chrome) height 55px By MUKUND 2-dec-2013 */
	  if ($.browser.webkit && this.offset.y == 55) {
		  this.offset.y = this.offset.y-55
	  }
	  /* additionaly removed over*/	
