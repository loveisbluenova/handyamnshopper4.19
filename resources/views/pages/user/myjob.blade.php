	    ...
	    <div class="col-lg-4" style="padding-bottom: 40vh;">
		 ...
		 <div class="list">
		  <div class="list-group">
           ...
           @if($state==1)
           <a href="/providerjob/{{Auth::user()->id}}" class="list-group-item active cat-list">
            <em class="fa fa-fw fa-check-circle text-muted"></em>&nbsp;&nbsp;&nbsp;Pending Jobs
            <span class="badge text-red-bg">{{$pending}}</span>
		   </a>
		  	@else
		  	<a href="/providerjob/{{Auth::user()->id}}" class="list-group-item cat-list">
            <em class="fa fa-fw fa-check-circle text-muted"></em>&nbsp;&nbsp;&nbsp;Pending Jobs
            <span class="badge text-red-bg">{{$pending}}</span>
		   </a>
		   @endif
		   ...
		   @if($state==2)
		   <a href="/providerjob/{{Auth::user()->id}}/runingjob" class="list-group-item active cat-list">
            <em class="fa fa-fw fa-check-circle text-muted"></em>&nbsp;&nbsp;&nbsp;Running Jobs
            <span class="badge text-red-bg">{{$runing}}</span>
		   </a>
		   @else
           <a href="/providerjob/{{Auth::user()->id}}/runingjob" class="list-group-item cat-list">
            <em class="fa fa-fw fa-check-circle text-muted"></em>&nbsp;&nbsp;&nbsp;Running Jobs
            <span class="badge text-red-bg">{{$runing}}</span>
		   </a>
		   @endif
		   ...
		   @if($state==3)
		   <a href="/providerjob/{{Auth::user()->id}}/completejob" class="list-group-item active cat-list">
            <em class="fa fa-fw fa-check-circle text-muted"></em>&nbsp;&nbsp;&nbsp;Completed Jobs
            <span class="badge text-red-bg">{{$completed}}</span>
		   </a>
		   @else
		   <a href="/providerjob/{{Auth::user()->id}}/completejob" class="list-group-item cat-list">
            <em class="fa fa-fw fa-check-circle text-muted"></em>&nbsp;&nbsp;&nbsp;Completed Jobs
            <span class="badge text-red-bg">{{$completed}}</span>
		   </a>
		 	@endif
