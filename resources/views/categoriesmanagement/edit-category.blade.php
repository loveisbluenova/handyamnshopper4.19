        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <a href="/categories" class="btn btn-info btn-xs pull-right">
              ...
              <span class="hidden-xs">Back to </span>Categories
            </a>

          </div>

          {!! Form::model($category, array('action' => array('CategoriesManagementController@update', $category->id), 'method' => 'PUT')) !!}
            ...
            <div class="panel-body">
               ...
               <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                {!! Form::label('cate_name', trans('Category'), array('class' => 'col-md-3 control-label')); !!}
                <div class="col-md-9">
                  <div class="input-group">
                    {!! Form::text('cate_name', NULL, array('id' => 'cate_name', 'class' => 'form-control', 'placeholder' => trans('Category'))) !!}
