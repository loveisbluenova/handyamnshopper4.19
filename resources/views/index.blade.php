	 ...
	 <header class="header-one">
      <div class="container">
	   <div class="content">
        ...
        <div class="row">
		 <h1 class="name revealOnScroll" data-animation="fadeInDown" style="font-size: 50px;">Handymanshopper</h1>
		 <p class="temp"><br></p>
		 ...
		 <div class="col-lg-4 col-md-4 col-sm-6">
		  <a href="services.html">
		   <div class="features seven">
		    <img src="img/home/heating.jpg" class="img-responsive" alt=""/>
		   </div><!-- /.features -->
		   <div class="spacer">
		  ...
		  <a href="services.html">
		   <div class="features eight">
		    <img src="img/home/service.jpg" class="img-responsive" alt=""/>
		   </div><!-- /.features -->
		   <div class="spacer">
		   	<h4>Other Handyman Service</h4>
